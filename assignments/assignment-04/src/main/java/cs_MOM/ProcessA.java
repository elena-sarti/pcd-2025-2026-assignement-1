...
public class ProcessA {
    ...
    private final static String MY_PRIVATE_QUEUE = "Queue_Process_A";
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("[Process A] Asking for permission to enter CS...");
        ...
        DeliverCallback permissionCallback = (consumerTag, delivery) -> {
            System.out.println("[Process A] msg received from middleware: " + new String(delivery.getBody(), StandardCharsets.UTF_8));

            // --- BEGINNING CS ---
            System.out.println("[Process A] >>> Entered in CS at " + System.currentTimeMillis() + " <<<");
            try {
                Thread.sleep(4000);
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
            System.out.println("[Process A] <<< Leaving CS at " + System.currentTimeMillis() + " <<<");
            // --- END CS ---
