...
import static threads.model.BallImpl.RESTITUTION_FACTOR;
...
public class BoardImpl implements Board {
    ...
    public static void resolveCollision(BallImpl a, BallImpl b, String ballType) {
        ...
        if (dist < minD && dist > 1e-6) {
            ...
            a.setPost(new P2d(a.getPos().x() - a_deltax, a.getPos().y() - a_deltay));
            double b_factor = overlap * (a.getMass() / totalM);
            double b_deltax = nx * b_factor;
            double b_deltay = ny * b_factor;
            b.setPost(new P2d(b.getPos().x() + b_deltax, b.getPos().y() + b_deltay));
            /* Update velocities */
